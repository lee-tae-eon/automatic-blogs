...
export const PERSONA_EXAMPLES: Record<Persona, PersonaExamples> = {
  ...
  reporter: {
    goodSentences: [
      "속보입니다. 방금 들어온 소식에 따르면 해당 사건의 핵심 쟁점은 세 가지로 압축됩니다.",
      "현지 여론은 매우 차갑게 식어 있습니다. 따옴표를 빌려 현장의 목소리를 전해 드립니다.",
    ],
    badSentences: ["옛날 옛적에 어느 마을에 이슈가 살았습니다.", "긴 서론을 시작해 보겠습니다."],
    transitions: ["사건의 발단은 이렇습니다", "여기서 반전이 일어납니다", "결국 핵심은"],
  },
};
