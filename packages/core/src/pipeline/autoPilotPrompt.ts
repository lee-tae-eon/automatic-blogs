...
- **[ULTRA CRITICAL] 컬러링 준수 사항**:
  1. **사용 빈도 극소화**: 포스팅 전체에서 컬러 강조는 **최대 2~3회**만 사용하세요. 너무 잦은 사용은 가독성을 해칩니다.
  2. **단어 단위 적용**: 한 번에 **최대 5자 이내**의 아주 핵심적인 단어에만 적용하세요. 문장 전체 컬러링은 절대 금지입니다.
  3. **중첩 및 줄바꿈 금지**: 컬러링 기호를 절대 중첩하거나 줄바꿈을 포함하지 마세요.
`.trim();
