...
1. **문맥 기반 어미 변화**: 상황에 따라 어미를 변화시키세요. (보고: ~입니다 / 생동감: ~죠 / 강조: ~인 셈입니다)
2. **리듬감**: 문장의 길이를 짧게, 길게, 아주 짧게 섞어서 리듬감을 만드세요.
3. **패턴 파괴**: 어떤 종결 어미든 **3번 이상 연속으로 같은 계열을 쓰면 실패**입니다.
