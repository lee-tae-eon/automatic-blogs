...
export const TONE_CONFIG: Record<Tone, ToneConfig> = {
  professional: {
    ...
    ending: "하십시오체 기반이되, 리듬감을 위해 다양한 종결어미(~이죠, ~입니다, ~인 셈입니다 등) 혼용",
    examples: [
      "2026년 기준 국내 시장 점유율은 35%에 달합니다. 전년 대비 12%나 가파르게 상승한 수치이죠.",
      "이 방법은 평균 40%의 효율 개선 효과가 이미 입증된 상태입니다.",
      "연구 결과에 따르면, 해당 기술은 향후 5년간 시장의 주류가 될 것으로 전망됩니다.",
    ],
    avoid: ["~것 같아요 (추측성)", "개인적으로 생각하기에", "느낌이 들어요", "ㅋㅋ, ㅎㅎ"],
  },
